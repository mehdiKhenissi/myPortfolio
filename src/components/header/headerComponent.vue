...
<template>
  ...
  >
    ...
    <ul
      :class="[
        'flex flex-col md:flex-row md:space-x-6 md:items-center md:static absolute left-0 md:w-auto bg-transparent-900/10 md:bg-transparent-900/10 rounded-lg transition-all duration-300',
